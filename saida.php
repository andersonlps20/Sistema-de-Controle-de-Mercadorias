...
<div class="navbar">
        ...
        <div class="menu">
            ...
            <a href="#" href="#" style="color:rgb(255, 255, 255); background-color: #494a49; cursor:default;">Registrar Saída</a>
    ...
    <h1>Registrar Saída de Mercadoria</h1>
    <form method="POST">
        <label>ID da Mercadoria:</label>
        <input type="number" name="id" required>

        <label>Nome do Produto:</label>
        <div id="nomeProduto" style="margin-bottom: 15px; color: red;"></div>
